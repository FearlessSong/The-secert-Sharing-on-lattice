...
int main(int argc, char *argv[])
{
  ...
  status |= test_filename<mpz_t>(TESTDATADIR "/tests/lattices/example_cvp_in_lattice4",
    ...
    */
  status |= test_filename<mpz_t>(TESTDATADIR "/tests/lattices/example_cvp_in_lattice6",
                                 TESTDATADIR "/tests/lattices/example_cvp_in_target6",
                                 TESTDATADIR "/tests/lattices/example_cvp_out6", CVPM_PROVED);
